...
class DarkestDungeonWorld(World):
    ...
    def set_rules(self):
        ...
        self._add_entrance_rule(RegionNames.DARKEST.value, [ItemNames.DARKEST_KEY.value] + 4 * [ItemNames.DD_MARK.value])
        ...
        self._add_entrance_rule(RegionNames.SURVIVALIST.value, [ItemNames.SURVIVALIST_KEY.value])
